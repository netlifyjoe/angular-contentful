...
import type { CustomActionClientModel, CustomActionDocument, CustomActionObjectModel } from './custom-actions';
...
export type ObjectClientModel = Omit<ObjectModel, 'context' | 'preview' | 'actions' | 'fields' | 'permissions'> & {
    ...
    actions?: CustomActionClientModel<CustomActionObjectModel>[];
    fields: ClientField[];
...
> & {
    preview?: PreviewFields;
    actions?: CustomActionClientModel<CustomActionDocument>[];
    filePath?: string;
    fields: ClientField[];
    permissions?: ModelPermissions;
};
